...
# use-after-free fixed in atari57_replay.nim (emscripten_exit_with_live_runtime)
...
# atari57_error_len(). Aborting keeps linear memory intact, and the page reads
# atari57_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "atari57_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_atari57_load_replay,_atari57_frame,_atari57_input,_atari57_packet_ptr,_atari57_packet_len,_atari57_mismatch_tick,_atari57_error_ptr,_atari57_error_len,_atari57_stage_ptr,_atari57_stage_len
  """).replace("\n", " ")
)
