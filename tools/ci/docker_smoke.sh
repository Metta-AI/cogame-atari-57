...
# Substitute: atari-57, coworld-atari-57, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-atari-57:ci)
#   SMOKE_SLUG                 game slug                        (atari-57)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/atari-57)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/atari-57-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-atari-57:ci}}"
slug="${SMOKE_SLUG:-atari-57}"
